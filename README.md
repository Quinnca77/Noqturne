...
- Running from source with IntelliJ (Community edition can be found [here](https://www.jetbrains.com/idea/download/)):
  - Clone the repository
  - Make sure you have installed the IntelliJ plugin `Swing UI Designer`.
  - Run src/main/java/org/noqturne/Main
